...
class SumImageData(Dataset):
    def __init__(self, train_dir, transform=None):
        self.train_dir = train_dir
        self.origin_paths = [os.path.join(train_dir, 'noise', img_name) for img_name in
                             os.listdir(os.path.join(train_dir, 'noise'))]
        self.noise_paths = [os.path.join(train_dir, 'denoise', img_name) for img_name in
                            os.listdir(os.path.join(train_dir, 'denoise'))]
